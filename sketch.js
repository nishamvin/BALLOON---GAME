...
var hyponoticBallPosition=database.ref('balloon/position');
...
function draw() {
  ...
  text("press space to decrease the scale",10,200)
  text("press 0 to increase the scale",10,250)
...
function keyPressed(){
  ...
  if(keyCode==48&&hyponoticBall.scale<30){
    hyponoticBall.scale=hyponoticBall.scale+0.2;
  }
}
